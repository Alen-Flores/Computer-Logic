window.addEventListener('load', () => {
  ...
  let circuitData = {
    "devices": {
      input1: { "label": "x", "type": "Button", "bits": 1, },
      input2: { "label": "y", "type": "Button", "bits": 1, },
      output1: { "label": "carry", "type": "Lamp", "bits": 1, },
      output2: { "label": "out", "type": "Lamp", "bits": 1, },
  ...
  circuit.displayOn(document.getElementById("half-adder"));
  circuit.start();

  let equation = document.getElementById("half-adder-equation");
